...
Soil samples were dredged from the site prepared for construction works on behalf of the SCA Biorefinery Östrand AB. The samples are presented by the boreal clayey silt soils collected in the coastal area of the Baltic Sea, Sweden. The study area is located in the coastal region of Timrå municipality, Bothnian Bay, Figure \ref{fig:01}. The sampling has been performed on various sites, Nr. A1--A8, B1--B24. The sieve analysis was used to determine grain size distribution. 
