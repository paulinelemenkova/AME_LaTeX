...
Changing binder ratios enabled a better control of the mixing process in the \emph{in-situ} field sampling, so that quality requirements were achieved and project uncertainties were reduced. A robust recipe of the soil mixture with binders included 120 kg of binder per $m^3$ of the dredged silt aimed to provide a sufficiently low permeability level at several different water quotas during the tests. A graph showing the permeability of the $H_WL_B$ with changed ratio of binders Portland cement/slag is shown in Figure \ref{fig:06a}. The results of the permeability tests show different materials and binder ratios. The duplicate experiments have been performed on all the samples. The permeability gradually decreased along with added slag and reduced Portland cement, and vice versa, within each case of mixture, Figure \ref{fig:06b}. 
...
Figure \ref{fig:07a} shows a 2D response area for the permeability tests. The results show a strong negative interaction between the binder content and water ratio. Figure \ref{fig:07b} shows a 3D response area for the permeability tests. The results show a strong negative interaction between binder content and water ratio. Thus, at higher water ratio and lower amount of binder, the permeability increases in 10 times for both cases, Figure \ref{fig:07a} and \ref{fig:07b}. All tests are performed as double tests during Phase 2. 
...
The main contribution of this paper is to demonstrate that stabilising soil by various amount of binder as Portland cement and Bremen slag (GGBFS) improves soil parameters through the increased compressive strength, compactness and decreased permeability. To this end, a series of the  tests has been performed to determine physical and mechanical properties of silts. The sieve analysis was performed to evaluate grain size distribution. The experiments evaluated compressive strength, compactness and permeability of soil stabilised by various ratio of binder performed according to standards of SIS. The binder included two types: Portland cement and slag (GGBFS). The amounts of binder/water were changed to find the optimal ratio having the best effect on stabilisation. The modified Proctor compaction tests aimed to determine soil density by heavy laboratory compaction. 

We proposed a workflow with a mixture trials of binders in various proportions (30/70\%, 50/50\% and 70/30\% of Portland cement/Bremen slag). The quality control procedures were evaluated during the tests on P-wave velocity. The performance of the stabilised soil shown dependency of the permeability, compactness and strength on the ratio of binders. The 70\% Portland cement and 30\% of GGBS shows the highest permeability ($1.4\mathrm{e}^{-7}$) in the $H_WL_B$ ratio. 50\% Portland cement and 50\% GGBS shows $6.6\mathrm{e}^{-8}$ permeability in the same binder ratio. The lowest permeability is recorded by the ratio of binders 30\% Portland cement and 70\% slag with notably decreasing permeability up to (=$2.2\mathrm{e}^{-10}$).

A comparison of the UCS in soil stabilised by various proportions of binder was performed using P-waves velocity which proved to be a fast, robust and reliable method for evaluating  soil strength. Since measuring the P-wave velocity is a non-destructive approach, it has the advantage in the repeatability of testing, reduced, number of tests and optimised workflow. Adding binders in various ratios was flexibly changed to determine the properties of the stabilized soil. The P-wave velocities were determined on samples of loamy silt stabilized with mixtures of two agents (cement/slag). The compression strength, compactness and permeability were determined using the UCS tests, SGI method for testing permeability (edition 15) and modified Proctor compaction test. Soil compaction identified using Proctor compaction test demonstrated a tight correlation between water ratio in the pores of soil and dry density of soil. The variation in the ultrasonic P-waves velocity and UCS of soil stabilised by binders in various ratios were evaluated. The P-waves increased along with the increasing strength over time. Higher velocities were recorded for soil stabilised by binder ratio cement/slag as 30/70\%, while lower velocities were obtained for ratio cement/slag as 70/30\%. 

The velocity of the P-waves increased with the increasing strength of soils and time of curing. Specifically, it was more pronounced for the case of soil collected from the B4 testing site where $150 kg/m^3$ of binder was used for samples compared to the test A4 with 120 kg of binder. This demonstrated the direct effects of binder admixture on the overall increase of strength. The transmission of the P-waves occurs along the fastest path in the structure of the soil mass, which is directly related to the strength and stiffness of the stabilised specimen. Hence, stabilised soil with the $H_BL_W$ content demonstrated higher strength and increased velocity of P-waves compared to the samples with the $H_WL_B$  content. Our results demonstrated that admixture of the stabilising agents (Portland cement and GGBFS) in various ratios increases soil strength. The results can be considered in similar studies on silts dredged from the coastal areas. Future research can include experiments on changing the binder ratio and develop more criteria for the S/S treatment of silts.
