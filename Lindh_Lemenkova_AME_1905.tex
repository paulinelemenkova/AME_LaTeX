...
The samples \hl{included} mixes of \hl{cement and slag with} appropriate proportions at both 120 and 150 kg of binder volume per $m^3$ of the dredged silt. The workflow included simultaneous evaluation of soil mixes that consisted of the dredged masses of silt. Tested samples consisted of various binder proportions and water ratio which provided information on soil properties that can be used to control the \emph{in-situ} earthwork process in the field.  
