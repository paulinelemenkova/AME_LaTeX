...
\hl{This study presents the evaluation of soil strength, compactness and permeability with a case of } stabilised loamy silts. \hl{We used methods of} UCS, permeability tests and modified Proctor test. \hl{Soil density was assessed using the} modified Proctor compaction tests by heavy laboratory compaction. The Proctor method \hl{was effective in evaluating the compactness of soil and demonstrated} a tight correlation between water ratio in the pores and dry density of soil. 

\hl{Soil strength was estimated using applied geophysical methods. We evaluated the velocity of P-waves passing through the soil samples stabilised by various proportions of cement/slag for comparison of their effects}. The amounts of binder/water were also changed to find the optimal ratio with the best effect on stabilisation. \hl{Using the experimental changes of binders we have demonstrated their effects on soil strength. Estimating P-wave velocities} proved to be a fast, robust and reliable method for evaluating soil strength. \hl{Its}advantages include repeatability of testing, reduced number of tests and optimised workflow. 

\hl{We demonstrated that the} stabilisation of soil by various amount of binder improves its parameters: increased compressive strength, compactness and decreased permeability. The P-wave velocity increased along with the increasing soils strength and time of curing. Higher velocities were recorded for soil stabilised by binder with \hl{higher ratio of slag}, while lower velocities were obtained for \hl{higher ratio of cement, respectively}. The \hl{effectiveness} of P-waves \hl{for measuring soil strength is explained by its physical nature, as it passes} along the fastest path in the structure of the soil, which is directly related to the strength and stiffness of \hl{specimen}. 

\hl{Overall, the experiments proved the direct effects of the proportions of binders on the} permeability, compactness and strength of the stabilised soil. \hl{For comparison we used the experiments on three different rations of binders added to soil samples. The highest permeability of soil was recorded by samples with increased amount of cement, while the lowest permeability was recorded by increased proportions of slag}. Thus, the stabilised soil with \hl{higher binder ratio} shown higher strength and increased velocity of P-waves compared to the samples with the \hl{higher water} content. Our results can be considered in similar studies on dredged silts \hl{using admixture of the stabilising agents in various ratios to increase soil strength}. Future research can also include the experiments on changing binder ratio and developing more criteria for the S/S treatment of silts.
