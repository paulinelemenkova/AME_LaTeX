...
\hl{This study presents the evaluation of soil strength, compactness and permeability with a case of } stabilised loamy silts. \hl{We used methods of} UCS, permeability tests and modified Proctor test. \hl{The soil density was assessed using} modified Proctor compaction tests by heavy laboratory compaction. The Proctor method \hl{was effective in evaluating the compactness of soil and demonstrated} a tight correlation between water ratio in the pores and dry density of soil. 

The \hl{soil strength was estimated using measured velocity of P-waves. We evaluated P-waves passing through soil samples stabilised by various proportions of Portland cement/Bremen slag for comparison of their effects}. The amounts of binder/water were changed to find optimal ratio with the best effect on stabilisation. \hl{Using experimental changes of binders have demonstrated their effects on soil strength. Method of P-wave velocities} proved to be a fast, robust and reliable method for evaluating soil strength. \hl{Its}advantages include repeatability of testing, reduced number of tests and optimised workflow. 

The stabilisation of soil by various amount of binder improves its parameters: increased compressive strength, compactness and decreased permeability. \hl{For comparison we have used the experiments on three different rations of binders added to soil samples. The highest permeability of soil was recorded by samples with increased amount of Portland cement, while the lowest permeability was recorded by increased proportions of slag}. The P-wave velocity increased along with the increasing soils strength and time of curing. Higher velocities were recorded for soil stabilised by binder with ratio of slag, while lower velocities were obtained for higher ratio of cement.

\hl{Overall, the experiments} demonstrated \hl{the effects of ratio of binders on the} permeability, compactness and strength of the stabilised soil. This study demonstrated the direct effects of binder admixture on the overall increase of strength. 
