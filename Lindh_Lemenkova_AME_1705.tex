...
The present study examines physical and mechanical properties of soil samples, including compression behaviour, permeability and compactness. The specimens were collected in a test site located in Timrå municipality, Östrand area of Bothnian Bay, Sweden. The soil type predominantly included loamy silts, followed by sand and gravel. The study \hl{had the} ultimate goal to test bearing capacity of ground prepared for planned construction works \hl{using S/S processing and testing using cement/slag admixtures}. The specific objectives of this study include the following tasks: 
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \label{fig:02b}
  \end{subfigure}
  \caption{(a) Binder combinations of Portland cement (CEM II / A-V) and slag (GGBFS); (b) \hl{Factorial experiment with water ratio and amount of binder as variables.}}
  \label{fig:02}
\end{figure}
