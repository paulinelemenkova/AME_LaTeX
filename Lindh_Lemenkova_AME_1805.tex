...
\subsection{Phase 1}
The stabilisation of soil adopted existing general procedure requirements developed by SIS \cite{SIS2018}. To optimise the workflow, a special methodology was used based on the statistical experimental planning and SGI. The experimental trials of the soil mixture procedure were used to find the optimal ratio of water and stabilising agent. Here Portland \hl{cement} and GGBFS were tested in varied proportions.  
