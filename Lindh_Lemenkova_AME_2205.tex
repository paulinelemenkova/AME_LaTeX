...
Soil samples were dredged from the site prepared for construction works on behalf of the SCA Biorefinery Östrand AB. \hl{The samples are presented by the boreal clayey silt soils collected in the coastal area of the Baltic Sea, northern Sweden}. The exact study area is located in the coastal region of Timrå municipality, Bothnian Bay, Figure \ref{fig:01}. The sampling has been performed on various sites, indicated \hl{as Nr.} A1--A8, B1--B24 \hl{in} Figure \ref{fig:01} showing the \hl{their location}. \hl{The} sieve analysis was used to \hl{determine the grain size distribution analysis of soil}. 
