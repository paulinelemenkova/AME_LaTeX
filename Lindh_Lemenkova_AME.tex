...
The use of P-waves is a modern non-destructive aimed to analyse strength of the stabilised soils. The applicability of this method consists in the relationship between the velocity of waves the physical properties of material. Thus, the velocity of propagation of the ultrasonic P-waves within a soil mass is controlled by mechanical, structural and elastic properties of soil. Therefore, solving the inverse problem, measured velocities of P-waves can indicate strength properties of soil, needed to assess its bearing capacity. Besides, non-destructive methods provide a rapid, robust and reliable approach to analyse the stabilized soils, alternative to the existing traditional methods, for example, detecting early micro damages in concrete and other building materials \cite{Rydenetal2016}. Therefore, measuring velocities of the ultrasonic P-waves was performed to evaluate strength of the stabilised soil. 

The specimens had a diameter of ca. 50 mm and a height of ca. 100 mm. The strength is determined according to the ISO / TS 17892-7 \cite{SIS2017} using SIS technical guidance. The deformation rate was about 1\% / min which gives an approximate speed of 1 mm/min at the specimen size. The results of the UCS tests are presented in Figure \ref{fig:09}. Shear strength of the tested specimens is obtained by multiplying the compressive strength by 0.5. All the recipes meet the requirements for a minimum compressive strength of 280 kPa, compared with the laboratory study. The UCS and P-wave velocities were recorded for materials taken from the sample sites A4 and B4 with 120 and 150 kg of binder per $m^3$ of the dredged material. 
...
The results of the UCS tests for each mixture are shown in Figure \ref{fig:09}. The result must be multiplied by 0.5 to obtain shear strength. For material taken from the A4 site (see Figure 1) with a water ratio of about 135\%, an increase in the amount of binder means a doubling in strength. This effect is not visible for material taken from the B4 site (see Figure 1) with a water ratio of about 69\%. Different amounts of binder are shown in the legend. Variation of the P-wave velocity that changed with varying compression characteristics of the stabilized soils was also evaluated. Figure \ref{fig:10} shows P-wave velocity of the specimens collected in testing sites A4 and B4 of the study area. Similar to the results of the UCS tests, the scattering increases with the increasing P-wave velocity. However, the increase in the distribution of data is in general lower and the overlap between the B4\_120 and B4\_150 is considerably lower. The B4\_120 shows the graph for soil collected from the test site B4 stabilised by 120 kg of binder, while B4\_150 is the same, stabilised by 150 kg of binder, respectively. 
...
This tests included developing a workflow that included a mixture design of binders in various proportions (30/70\%, 50/50\% and 70/30\% of Portland cement/slag GGBS composition) and quality control procedures which were evaluated during the series of soils testing by P-waves. Properties and behaviour of the S/S soils shown to be dependent on binder content as stabilising agents. Therefore, the experiments have been performed for each recipe and values of compressibility and permeability were recorded for each binder combination. 
