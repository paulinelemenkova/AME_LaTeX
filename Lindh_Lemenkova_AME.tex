...
The response area from the analysis is reported in Figure \ref{fig:06} (2D and 3D, respectively). In the yellow-red areas, a significant interaction is shown between the change in the amount of binder and water ratio. The correlation results in a sharp deterioration in technical and environmental quality of soil through increased permeability from about $10^{-7} m/sec$ to $10^{-8} m/sec$. Strong interaction demonstrates the importance of working with finely adjusted recipe optimisation at the laboratory level during soil testing. The goal was to enable a better control of the mixing process in the \emph{in-situ} field sampling, so that set quality requirements are achieved and project uncertainties are reduced. A robust recipe of soil mixture with binders should contain 120 kg of binder per $m^3$ of the dredged silt material aimed to provide a sufficiently low permeability level at several different water quotas during tests.   
